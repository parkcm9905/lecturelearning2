...
public class NoteController : MonoBehaviour
{
    ...
    private float beatInteral = 1.0f;
    ...
    IEnumerator AwaitMakeNote(Note note)
    {
        ...
        yield return new WaitForSeconds(startingPoint + order * beatInteral);
        MakeNote(note);
    }
    void Start()
    {
    ...
    {
        yield return new WaitForSeconds(startingPoint + order * beatInteral + 8.0f);
        GameResult();
    }
